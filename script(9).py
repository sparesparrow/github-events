...
# Save unit tests for API
with open("github_events_monitor/tests/unit/test_api.py", "w") as f:
    f.write(unit_tests_api)

print("✅ Created github_events_monitor/tests/unit/test_api.py")
print(f"📊 Size: {len(unit_tests_api)} characters")