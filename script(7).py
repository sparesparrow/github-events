...
# Save the MCP server module
with open("github_events_monitor/mcp_server.py", "w") as f:
    f.write(mcp_server_code)

print("✅ Created github_events_monitor/mcp_server.py")
print(f"📊 Size: {len(mcp_server_code)} characters")
print("\nMCP Server features:")
print("\n🔧 MCP Tools (Model-controlled):")
print("- get_event_counts(offset_minutes) - Get event counts by type")
print("- get_avg_pr_interval(repo_name) - Calculate PR intervals")
print("- get_repository_activity(repo_name, hours) - Get repo activity")
print("- get_trending_repositories(hours, limit) - Get trending repos")
print("- collect_events_now(limit) - Manual event collection")
print("\n📊 MCP Resources (Application-controlled):")
print("- github://events/status - Server status")
print("- github://events/recent/{event_type} - Recent events by type")
print("\n📝 MCP Prompts (User-controlled):")
print("- analyze_repository_trends(repo_name) - Generate analysis prompts")
print("- create_monitoring_dashboard_config(hours) - Dashboard setup prompts")
print("- repository_health_assessment(repo_name) - Health assessment prompts")
print("\n✨ Additional features:")
print("- Background event collection")
print("- Human-readable interpretations")
print("- Comprehensive error handling")
print("- Resource cleanup management")