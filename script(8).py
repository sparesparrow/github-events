...
# First, let's create unit tests for the core collector

unit_tests_collector = '''"""
...
# Save unit tests for collector
with open("github_events_monitor/tests/unit/test_collector.py", "w") as f:
    f.write(unit_tests_collector)

print("✅ Created github_events_monitor/tests/unit/test_collector.py")
print(f"📊 Size: {len(unit_tests_collector)} characters")